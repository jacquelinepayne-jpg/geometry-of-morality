...
`datasets/morality/care_harm/data_gen.py`. Blind ratings from me plus GPT-5.5, Claude Opus 5,
...
`datasets/morality/<name>/data_gen.py` on shared machinery in `datasets/morality/moral_common.py`:
